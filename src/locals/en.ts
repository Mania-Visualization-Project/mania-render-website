...
const resource: Record<TI18nKeys, string> = {
  ...
  'status-current_warning_replay_not_match': 'The replay file is not match the map file',
  'status-current_warning_audio_not_match': 'The audio file is not match the map file',
