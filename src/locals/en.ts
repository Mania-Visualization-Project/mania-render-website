...
const resource: Record<TI18nKeys, string> = {
  ...
  'error-beatmap_invalid': 'Beatmap file format is not correct! Please check your beatmap file.' ,
  'error-beatmap_not_found': 'No matching beatmap was found in the uploaded beatmap set. You can manually upload the specified beatmap file.  ',
  'error-error': 'Internal Server Error: {{message}}. Please inform us of this situation.',
  'error-render_failed': 'Video file generation failed! Please inform us of this situation.',
  'error-replay_invalid':  'Incorrect replay file format! Please check your replay file.',
  'error-time_exceeded': 'The connection to the server timed out. Please try again.',
