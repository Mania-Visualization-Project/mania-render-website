...
const resource: Record<TI18nKeys, string> = {
  ...
  'error-error': '内部错误：{{message}}。请将此情况反馈给我们。',
  'error-beatmap_not_found': '上传的谱包里未找到和回放匹配的谱面。您可以手动上传指定的谱面文件。',
  'error-render_failed': '视频文件生成失败！请将此情况反馈给我们。',
  'error-replay_invalid': '回放文件格式不正确！请检查您的回放文件。',
  'error-beatmap_invalid': '谱面文件格式不正确！请检查您的谱面文件。' ,
  'error-time_exceeded': '谱面文件格式不正确！请检查您的谱面文件。',
  ...
  'main-upload_map_hint': '支持 .osz, .osu, .mcz, .mc, .zip 文件',
